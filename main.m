...
for j = 1:l
    ...
    tic;
    [~, relErr_BGS, orthErr_BGS] = BGS_GMRES0(A, s, p, basisFunc, "CGS2", "CGS2", b, ctol);
    time_BGS = toc;
...
figure;
semilogy(5:5:100, errs(:,1), '-o', 'LineWidth', 1.5, 'MarkerSize', 6, 'DisplayName', 'RBGS'); hold on;
semilogy(5:5:100, errs(:,2), '-s', 'LineWidth', 1.5, 'MarkerSize', 6, 'DisplayName', 'BGS');
...
%exportgraphics(gcf, sprintf('%s_minrelative_error_vs_s.png', matnum));